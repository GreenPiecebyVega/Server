...
module Api
  module V1
    class UsersGameModesController < ApplicationController
      ...
      api :PATCH, 'users/game/modes/list', 'Lista dos modos de jogo do usuário'
      def index
      ...
      #############################
      api :PATCH, 'users/game/modes/active-game-mode', 'Atualiza o atual modo de jogo do usuário/account'
